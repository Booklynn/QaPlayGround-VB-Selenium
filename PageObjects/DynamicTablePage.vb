...
Public Class DynamicTablePage
    ...
    Public Sub VerifySuperHeroNameVisible(name As String)
        ...
        Dim isSuperHeroNameVisible As Boolean = driver.FindElement(By.XPath(superHeroName)).Displayed
    ...
    Public Sub VerifySuperHeroImageVisible(imageName As String)
        ...
        Dim isSuperHeroImageVisible As Boolean = driver.FindElement(By.CssSelector(superHeroImageName)).Displayed
    ...
    Public Sub VerifySuperHeroEmailVisible(email As String)
        ...
        Dim isSuperHeroEmailVisible As Boolean = driver.FindElement(By.XPath(superHeroEmail)).Displayed
    ...
    Public Sub VerifySuperHeroRealNameVisible(realName As String)
        ...
        Dim isSuperHeroRealNameVisible As Boolean = driver.FindElement(By.XPath(superHeroRealName)).Displayed
    ...
    Public Sub VerifyColumnVisible(column As String)
        ...
        Dim isSuperColumnVisible As Boolean = driver.FindElement(By.XPath(columnName)).Displayed
